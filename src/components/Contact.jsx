...
const Contact = () => {
  return (
    <div
      className="max-w-[800px] mx-auto md:mt-[5rem] mt-[8rem] text-center px-[2rem]"
      id="contact"
    >
      <AnimatedContent
        distance={150}
      ...
      <AnimatedContent
        ...
        threshold={0.2}
      >
        <button className="bg-[#3CD98E] mt-[1.5rem] hover:bg-[#2ecf7f] transition-all duration-200 text-black  py-2 px-6 rounded-full w-full cursor-pointer">
          Send Message
        </button>
      </AnimatedContent>
    </div>
